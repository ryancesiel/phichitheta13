...
<head>
	...
	<?php if(is_front_page()) { ?><link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/flexslider.css" type="text/css" media="screen" /> <?php } ?>
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/magnific.css">
	...
	<script src="<?php bloginfo('stylesheet_directory'); ?>/js/magnific.js"></script>
	...
	<div class="wrapper">
		<div class="header">
			<div class="w-container">
				<div class="logo"><a href="<?php echo home_url(); ?>" title="Go to the Home Page"><img src="<?php bloginfo('template_directory'); ?>/img/logo.png" alt="Go the Home Page" /></a></div>
